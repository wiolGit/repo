...
//@EnableJpaRepositories(basePackages = "com.example.apzumi2.repositories")
@EnableTransactionManagement
//@ComponentScan(basePackages="com.example.apzumi2")
public class DatabaseConfiguration {
	...
	public LocalSessionFactoryBean sessionFactory()
	{
		...
		factory.setPackagesToScan(new String[] {"com.example.apzumi2.model"});
		return factory;
	}
